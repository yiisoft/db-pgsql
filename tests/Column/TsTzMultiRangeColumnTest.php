...
final class TsTzMultiRangeColumnTest extends IntegrationTestCase
{
    ...
    public static function dataBase(): iterable
    {
        ...
        yield ['{["2024-01-01 10:00:00+00",)}', '{["2024-01-01 10:00:00+00",)}'];
        yield ['{(,"2024-01-10 10:00:00+00"]}', '{(,"2024-01-10 10:00:00+00"]}'];
        yield ['{(,)}', '{(,)}'];
        yield ['{}', '{empty}'];
        yield ['{}', '{}'];
        yield [
        ...
        yield [
            '{["2024-01-01 10:00:00+00","2024-01-01 15:00:00+00"],["2024-01-02 10:00:00+00","2024-01-02 15:00:00+00"),["2024-01-03 10:00:00+00","2024-01-03 15:00:00+00")}',
            new MultiRangeValue('["2024-01-01 10:00:00+00","2024-01-01 15:00:00+00"]', '["2024-01-02 10:00:00+00","2024-01-02 15:00:00+00")', '["2024-01-03 10:00:00+00","2024-01-03 15:00:00+00")'),
        ];
    ...
    {
        $db = $this->prepareConnection(['{["2024-01-01 10:00:00+00","2024-01-01 20:00:00+00"),["2024-01-02 10:00:00+00","2024-01-02 20:00:00+00"]}', '{["2024-01-03 10:00:00+00","2024-01-03 20:00:00+00")}']);
